      ...
      <main className={s.main}>
        <div className={s.container}>
          ...
          <button className={s.descriptionBtn} onClick={() => setReferralModalOpen(true)}>
            <svg xmlns="http://www.w3.org/2000/svg" className={s.questionSvg} fill="none" viewBox="0 0 25 25">
              <path fill="#647788" fillOpacity=".5" fillRule="evenodd" d="M12.5 25C19.404 25 25 19.404 25 12.5S19.404 0 12.5 0 0 5.596 0 12.5 5.596 25 12.5 25Zm-1.64-9.502h2.802c.013-.514.088-.94.225-1.28.136-.344.394-.683.771-1.015.436-.403.83-.781 1.182-1.133a4.54 4.54 0 0 0 .85-1.152c.214-.417.322-.905.322-1.465 0-.84-.183-1.546-.547-2.119-.365-.58-.889-1.016-1.572-1.309-.684-.293-1.501-.44-2.452-.44-.859 0-1.637.144-2.334.43-.69.28-1.243.727-1.66 1.339-.41.605-.625 1.393-.644 2.363h3.31c.013-.378.082-.68.205-.908.124-.235.284-.407.479-.518a1.32 1.32 0 0 1 .644-.166c.28 0 .511.055.694.166a.95.95 0 0 1 .42.479c.097.214.146.491.146.83 0 .273-.058.53-.176.771-.117.241-.286.479-.507.713a8.957 8.957 0 0 1-.791.732c-.345.3-.619.625-.82.977a3.81 3.81 0 0 0-.43 1.191 8.66 8.66 0 0 0-.118 1.514Zm.107 1.797a1.529 1.529 0 0 0-.508 1.172c0 .469.17.862.508 1.181.338.313.778.47 1.318.47s.98-.157 1.319-.47c.338-.319.507-.712.507-1.181 0-.469-.169-.86-.508-1.172-.338-.32-.777-.479-1.318-.479-.54 0-.98.16-1.318.479Z" clipRule="evenodd"/>
            </svg>
            <span>
              How it works?
            </span>
